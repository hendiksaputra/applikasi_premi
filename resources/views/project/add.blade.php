...
@section('breadcrumb')
    @parent
    <li class="active">Input Data Project</li>
@endsection
...
<div class="box box-primary">
      <div class="box-body">
        ...
        <div class="form-group  col-md-6">
          ...
          value="{{ old('code_project') }}" autofocus>
            @error('code_project')
        ...
        <div class="form-group  col-md-6">
          ...
          <input type="text" class="form-control" name="name_project"  class="form-control @error('name_project') is-invalid @enderror" value="{{ old('name_project') }}"
          autofocus>
            @error('name_project')
                <div class="has-warning form-group">{{ $message }}</div>
            @enderror
