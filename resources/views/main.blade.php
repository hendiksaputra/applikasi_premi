                ...
                <ul class="nav navbar-nav">
                    ...
                    <li class="menu-item-has-children dropdown">
                        ...
                        <ul class="sub-menu children dropdown-menu">
                            <li><i class="menu-icon fa fa-line-chart"></i><a href="{{ url('absensi_categorys') }}">Absensi Category</a></li>
                    ...
                    <li class="menu-item-has-children dropdown">
                        ...
                        <ul class="sub-menu children dropdown-menu">
                            <li><i class="menu-icon fa fa-line-chart"></i><a href="{{ url('sp_categorys') }}">SP Category</a></li>                          
                        </ul>
                    </li>
                    <li>
                    ...
                    <li>
                        <a href="{{ url('') }}"> <i class="menu-icon fa fa-dashboard"></i>Production Parameters </a>
                    </li>                         
                </ul>
