...
@section('title')
    Daftar Load Category
@endsection

@section('breadcrumb')
    @parent
    <li class="active">Load Category</li>
@endsection
...
<div class="content mt-3">
    <div class="box">
        <div class="box-header">
          <h3 class="box-title">Load Category Data Table</h3>
          <div class="pull-right">
            <a href="{{ url('load_categories/create') }}" class="btn btn-success btn-sm">
        ...
        <div class="box-body">
          ...
          <div class="row"><div class="col-sm-12">
            ...
            <tr role="row">
                ...
                <th class="sorting" tabindex="0" aria-controls="example2" rowspan="1" colspan="1" aria-label="Browser: activate to sort column ascending">Load Category Name</th>
            ...
            <tbody>
                @foreach ($loadCategories as $item)       
            <tr role="row" class="odd">
              <td class="sorting_1">{{ $loop->iteration }}</td>
              <td>{{ $item->name }}</td>
              <td class="text-center">
                
                <form action="{{ url('load_categories/' . $item->id) }}" method="post"
                  ...
                  <a href="{{ url('load_categories/' . $item->id . '/edit') }}" class="btn btn-primary btn-sm">
