...
<div class="box box-primary">
      <div class="box-body">
        ...
        <div class="form-group  col-md-6">
          ...
          value="{{ old('nik', $employee->nik) }}" autofocus>
            @error('nik')
        ...
        <div class="form-group  col-md-6">
          ...
          <input type="text" class="form-control" name="name_employee" class="form-control @error('name_employee') is-invalid @enderror"
          value="{{ old('name_employee', $employee->name_employee) }}" autofocus>
            @error('name_employee')
                <div class="has-warning form-group">{{ $message }}</div>
            @enderror
        </div>  
